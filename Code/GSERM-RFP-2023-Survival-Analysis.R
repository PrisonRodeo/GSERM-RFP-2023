...
P<-c("readr","gtools","plyr","nnet","mstate","texreg","survival",
     "eha","rms","flexsurv","pscl","smcure","nltm",
     "coxme")
...
KABL<-read_csv("https://github.com/PrisonRodeo/GSERM-RFP-2023/raw/main/Data/KABL.csv")
...
OR<-read_csv("https://github.com/PrisonRodeo/GSERM-RFP-2023/raw/main/Data/OR.csv")
